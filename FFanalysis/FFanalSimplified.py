...
def feedForward(x, params):
    ...
    for activation in activations:
        ...
        for i in range(10):#should run over 100 but is too time consuming, use this approximation
            z_i = z.take(i,axis=1)
...
print('got here')
batch_size = 1
divider = 200.0/batch_size
x_whole = x_test
Es=0.0
for i in range(200):
    print('Reached '+repr(i))
    Es += np.asarray(compute(x_whole[i:i+batch_size]))/batch_size
